...
const SendSMS = async function (intentRequest, callback) {
    ...
    try {
        ...
        appSession.stateName = appSession.baseLine + "_SendSMS";
        //------------PUT CXI Keys----------------------------
        ...
        appSession.nextStateName = process.const.NS_SendSMSDiffSamePhNo;
